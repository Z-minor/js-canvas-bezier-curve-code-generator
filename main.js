...
function 空代碼跑馬燈(){
  if(計時器%300<50){
    代碼="版本1.0　2022夏　by琴房關燈俠<br/><br/>請先調整輸出尺寸，再開始繪製曲線。<br/>如果繪製曲線後，才縮小輸出尺寸，<br/>已繪製的曲線，可能會溢出畫面而無法完整顯示。<br/><br/>新增的線段，將於當前被選取的控制點旁生成。<br/>點擊空白處，可以使用矩形選取。<br/><br/>左下角白色橫條為比例尺，顯示所選輸出尺寸的實際寬度。<br/><br/>內置代碼修正功能，直線線段與二次貝茲曲線，將轉換為對應代碼。<br/><br/><br/><br/>代碼將生成於此處";
  }
